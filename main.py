...
{{
  ...
  "telco": {{
    "LGU": {{"품질": "...", "품질_url": "관련 기사 URL", "AI": "...", "AI_url": "관련 기사 URL", "신사업": "...", "신사업_url": "관련 기사 URL"}},
    "KT":  {{"품질": "...", "품질_url": "관련 기사 URL", "AI": "...", "AI_url": "관련 기사 URL", "신사업": "...", "신사업_url": "관련 기사 URL"}},
    "SKT": {{"품질": "...", "품질_url": "관련 기사 URL", "AI": "...", "AI_url": "관련 기사 URL", "신사업": "...", "신사업_url": "관련 기사 URL"}}
  }},
  "summary": [
    "요약 문장 1",
    "요약 문장 2",
...
ai_news는 국내외 AI 관련 주요 뉴스 5~8건을 포함하세요. url은 반드시 실제 기사 URL을 넣어주세요. 웹 검색 결과에서 찾은 실제 링크를 사용하세요.
companies는 네이버, 카카오, 현대차, 삼성, LG, 쿠팡 등 국내 주요 대기업 중 오늘 뉴스에 등장한 기업만 포함하세요. 없으면 빈 배열로 두세요. url은 반드시 실제 기사 URL을 넣어주세요.
telco의 각 항목 url도 반드시 실제 기사 URL을 넣어주세요. 기사를 찾을 수 없을 때만 빈 문자열로 두세요.
